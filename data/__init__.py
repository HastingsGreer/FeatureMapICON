...
def DavisEval(model, name):
    ...
    for sequence in sequences:
        ...
        first_annotation = np.array(Image.open(davis_path + "Annotations/480p/" + sequence + "/00000.png"))
        ...
        for i in range(1, len(os.listdir(sequence_img_path))):
            ...
            annotation = model(first_image, first_annotation, prev_image, prev_annotation, curr_image)
